...
INSERT INTO Pago (pagado, fecha_pago, id_medio, id_pedido) VALUES
-- Pedidos entregados o aceptados, con pago registrado
(TRUE, NOW(), 2, 2),
(TRUE, NOW(), 3, 3),
(TRUE, NOW(), 4, 4),
(TRUE, NOW(), 5, 5),
...
-- Pedidos pendientes o cancelados → no pagados
(FALSE, NULL, 1, 1),
(FALSE, NULL, 1, 7),
(FALSE, NULL, 1, 31),
(FALSE, NULL, 1, 32),
...
INSERT INTO ProductoXPedido (id_producto, id_pedido, cantidad, precio_unitario) VALUES
-- Pedido 1
(25,1,2,450.00),(26,1,1,350.00),
-- Pedido 2
(28,2,1,200.00),(29,2,2,150.00),(30,2,1,300.00),
-- Pedido 3
(31,3,3,120.00),
-- Pedido 4
(34,4,1,700.00),(35,4,1,450.00),
-- Pedido 5
(37,5,1,250.00),(38,5,2,300.00),(39,5,1,400.00),
-- Pedido 6
(40,6,2,180.00),(41,6,1,120.00),
-- Pedido 7
(43,7,1,350.00),(44,7,1,400.00),(45,7,2,250.00),
-- Pedido 8
(47,8,1,500.00),(48,8,1,600.00),(49,8,1,550.00),
-- Pedido 9
(51,9,1,300.00),(52,9,2,250.00),
-- Pedido 10
(55,10,1,100.00),(56,10,1,120.00),(57,10,2,90.00),
-- Pedido 11
(60,11,2,800.00),(61,11,1,650.00),
-- Pedido 12
(63,12,1,50.00),(64,12,3,60.00),(65,12,1,45.00),
-- Pedido 13
(67,13,1,120.00),(68,13,1,150.00),
-- Pedido 14
(70,14,2,80.00),(71,14,1,95.00),(72,14,1,60.00),
-- Pedido 15
(74,15,1,200.00),(75,15,2,150.00),
-- Pedido 16
(77,16,1,300.00),(78,16,1,350.00),(79,16,2,250.00),
-- Pedido 17
(81,17,1,400.00),(82,17,2,250.00),(83,17,1,300.00),
-- Pedido 18
(1,18,1,150.00),(2,18,2,200.00),
-- Pedido 19
(4,19,1,400.00),(5,19,1,350.00),(6,19,2,300.00),
-- Pedido 20
(7,20,1,250.00),(8,20,2,300.00),
-- Pedido 21
(10,21,1,700.00),(11,21,1,750.00),(12,21,2,800.00),
-- Pedido 22
(13,22,2,500.00),(14,22,1,450.00),
-- Pedido 23
(16,23,1,100.00),(17,23,1,150.00),(18,23,2,120.00),
-- Pedido 24
(19,24,1,250.00),(20,24,2,300.00),
-- Pedido 25
(22,25,1,180.00),(23,25,1,200.00),(24,25,2,150.00),
-- Pedido 26
(25,26,1,450.00),(26,26,1,350.00),
-- Pedido 27
(28,27,2,200.00),(29,27,1,150.00),(30,27,1,300.00),
-- Pedido 28
(31,28,1,120.00),(32,28,1,130.00),(33,28,2,110.00),
-- Pedido 29
(34,29,1,700.00),(35,29,2,450.00),
-- Pedido 30
(37,30,1,250.00),(38,30,2,300.00),
-- Pedido 31
(1,31,2,150.00),(2,31,1,200.00),
-- Pedido 32
(4,32,1,400.00),(5,32,2,350.00),(6,32,1,300.00),
-- Pedido 33
(7,33,2,250.00),(8,33,1,300.00),
-- Pedido 34
(10,34,1,700.00),(11,34,1,750.00),(12,34,1,800.00),
-- Pedido 35
(13,35,2,500.00),(14,35,1,450.00),
-- Pedido 36
(16,36,1,300.00),(17,36,2,350.00),(18,36,1,250.00),
-- Pedido 37
(19,37,1,400.00),(20,37,1,250.00),
-- Pedido 38
(22,38,2,180.00),(23,38,1,200.00),(24,38,1,150.00),
-- Pedido 39
(25,39,1,450.00),(26,39,1,350.00),
-- Pedido 40
(28,40,1,200.00),(29,40,2,150.00),(30,40,1,300.00),
-- Pedido 41
(31,41,1,120.00),(32,41,1,130.00),(33,41,2,110.00),
-- Pedido 42
(34,42,1,700.00),(35,42,2,450.00),
-- Pedido 43
(37,43,1,250.00),(38,43,2,300.00),
-- Pedido 44
(1,44,1,150.00),(2,44,2,200.00),
-- Pedido 45
(4,45,1,400.00),(5,45,1,350.00),(6,45,2,300.00),
-- Pedido 46
(7,46,1,250.00),(8,46,2,300.00),
-- Pedido 47
(10,47,1,700.00),(11,47,1,750.00),(12,47,2,800.00),
-- Pedido 48
(13,48,2,500.00),(14,48,1,450.00),
-- Pedido 49
(16,49,1,300.00),(17,49,1,350.00),(18,49,2,250.00),
-- Pedido 50
(19,50,1,400.00),(20,50,2,250.00),
-- Pedido 51
(22,51,1,180.00),(23,51,2,200.00),(24,51,1,150.00),
-- Pedido 52
(25,52,1,450.00),(26,52,1,350.00),
-- Pedido 53
(28,53,2,200.00),(29,53,1,150.00),(30,53,1,300.00),
-- Pedido 54
(31,54,1,120.00),(32,54,1,130.00),(33,54,2,110.00),
-- Pedido 55
(34,55,1,700.00),(35,55,2,450.00),
-- Pedido 56
(37,56,1,250.00),(38,56,2,300.00),
-- Pedido 57
(1,57,1,150.00),(2,57,2,200.00),
-- Pedido 58
(4,58,1,400.00),(5,58,1,350.00),(6,58,2,300.00),
-- Pedido 59
(7,59,1,250.00),(8,59,2,300.00),
-- Pedido 60
(10,60,1,700.00),(11,60,1,750.00),(12,60,2,800.00),
-- Pedido 61
(13,61,2,500.00),(14,61,1,450.00),
-- Pedido 62
(16,62,1,300.00),(17,62,1,350.00),(18,62,2,250.00),
-- Pedido 63
(19,63,1,400.00),(20,63,2,250.00),
-- Pedido 64
(22,64,1,180.00),(23,64,2,200.00),(24,64,1,150.00),
-- Pedido 65
(25,65,1,450.00),(26,65,1,350.00),
-- Pedido 66
(28,66,2,200.00),(29,66,1,150.00),(30,66,1,300.00),
-- Pedido 67
(31,67,1,120.00),(32,67,1,130.00),(33,67,2,110.00),
-- Pedido 68
(34,68,1,700.00),(35,68,2,450.00),
-- Pedido 69
